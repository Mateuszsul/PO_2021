...
/**
 * Wyrażenie logiczne '<=' (Mniejsze lub Równe) języka Robson.
 *
 * @author Mateusz Sulimowicz
 */
public class LessEqual extends BinaryArithmetic implements Logical {

    @SerializedName("typ")
    private static final String type = "<=";

    public LessEqual(Arithmetic left, Arithmetic right) {
        super(left, right);
    }
